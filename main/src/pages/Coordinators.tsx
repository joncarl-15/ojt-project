...
import { Search, Plus, Edit, Trash2, Mail, Loader2, Users } from 'lucide-react';
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-green-700 flex items-center gap-2">
                        <Users className="text-green-700" /> Coordinators
                    </h2>
                    <p className="text-green-600">Manage coordinator accounts and assignments</p>
                </div>
                <Button
