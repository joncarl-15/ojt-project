...
import { Search, Plus, UserPlus, Edit, Trash2, Loader2, GraduationCap } from 'lucide-react';
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-green-700 flex items-center gap-2">
                        <GraduationCap className="text-green-700" /> Students
                    </h2>
                    <p className="text-green-600">Manage student records and internship status</p>
                </div>
