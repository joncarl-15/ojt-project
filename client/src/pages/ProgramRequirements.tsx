    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-green-700">Program Requirements</h1>
                    <p className="text-gray-500 mt-1">Manage requirements for OJT programs</p>
                </div>
                <div className="flex gap-3">
                    ...
                    <Button onClick={handleCreate} className="bg-green-600 hover:bg-green-700 h-[42px]">
